...
class GameState {
  ...
  GameState copyWith({
    Object? currentPlayer     = _clear,
    Object? session           = _clear,
    GamePhase? phase,
    Object? scoringRules      = _clear,
    Object? currentQuestion   = _clear,
    int? questionIndex,
    int? answeredCount,
    int? totalPlayers,
    Object? correctAnswer     = _clear,
    Object? lastScoreDelta    = _clear,
    Object? lastSpeedBonus    = _clear,
    Object? lastStreakBonus   = _clear,
    List<PlayerScore>? topPlayers,
    Object? winnerPlayerId    = _clear,
    Object? rewardPointsGranted = _clear,
    Object? errorMessage      = _clear,
  }) {
    return GameState(
      currentPlayer:       currentPlayer == _clear       ? this.currentPlayer       : currentPlayer as Player?,
      session:             session == _clear             ? this.session             : session as GameSession?,
      phase:               phase ?? this.phase,
      scoringRules:        scoringRules == _clear        ? this.scoringRules        : scoringRules as ScoringRules?,
      currentQuestion:     currentQuestion == _clear     ? this.currentQuestion     : currentQuestion as Question?,
      questionIndex:       questionIndex ?? this.questionIndex,
      answeredCount:       answeredCount ?? this.answeredCount,
      totalPlayers:        totalPlayers ?? this.totalPlayers,
      correctAnswer:       correctAnswer == _clear       ? this.correctAnswer       : correctAnswer as String?,
      lastScoreDelta:      lastScoreDelta == _clear      ? this.lastScoreDelta      : lastScoreDelta as int?,
      lastSpeedBonus:      lastSpeedBonus == _clear      ? this.lastSpeedBonus      : lastSpeedBonus as int?,
      lastStreakBonus:      lastStreakBonus == _clear     ? this.lastStreakBonus     : lastStreakBonus as int?,
      topPlayers:          topPlayers != null ? List.unmodifiable(topPlayers) : this.topPlayers,
      winnerPlayerId:      winnerPlayerId == _clear      ? this.winnerPlayerId      : winnerPlayerId as String?,
      rewardPointsGranted: rewardPointsGranted == _clear ? this.rewardPointsGranted : rewardPointsGranted as int?,
